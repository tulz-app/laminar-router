  ...
  def set(
    ...
    val preparedKey =
      keyUriComponentsRegex
        ...
        .replaceAllLiterally("(", "%28")
        .replaceAllLiterally(")", "%29")

    val stringifiedAttributes = attributes.foldLeft("") {
      case (acc, (k, v)) =>
